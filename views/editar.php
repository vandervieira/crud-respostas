...
<?php if($linha['id'] == $_GET['editar']){ ?> <!-- ###### INICIO IF verificacao editar ###### -->
...
<textarea name="resposta_enviada" style="width:100%;" class="form-control" rows="3" required>
